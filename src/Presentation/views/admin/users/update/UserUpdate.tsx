...
interface Props
  extends StackScreenProps<AdminUserStackParamList, "AdminUserUpdateScreen"> {}

export const AdminUserUpdateScreen = ({ navigation, route }: Props) => {
      ...
      <View style={styles.form}>
        <ScrollView>
          ...
          <View style={styles.buttonContainer}>
            <RoundedButton text="EDITAR USUARIO" onPress={() => updateUser()} />
          </View>
        </ScrollView>
      </View>
      {loading && (
